...
from resolveai.models.models import Ticket, AgentRun, ToolCall, AgentDecision, Escalation
...
async def test_full_ticket_resolution_e2e(seeded_db: AsyncSession):
    ...
    assert "get_order" in tool_names or "get_shipment" in tool_names or "search_policy" in tool_names
