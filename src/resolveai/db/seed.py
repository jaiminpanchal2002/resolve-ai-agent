...
def seed_db():
    ...
    try:
        ...
        for i in range(1, 21):
            ...
            if not db.scalar(cust_stmt):
                ...
                s = Shipment(
                    ...
                    proof_of_delivery_url=None if is_high_value else f"https://tracking.carrier.com/proof_{shpid}.jpg",
                    signature_captured=False if is_high_value else True,
                    created_at=datetime.datetime.utcnow() - datetime.timedelta(days=5)
                )
                db.add(s)
        ...
        dataset_stmt = select(EvaluationDataset).where(EvaluationDataset.name == "Standard Support Suite")
                ...
                for k in range(1, 11):
                    ...
                    if cat == "delivered but missing" and k == 1:
                        ...
                        expected = {
                            ...
                            "expected_tools": ["get_customer", "get_order", "get_shipment", "search_policy"],
                            "expected_args": [
                        ...
                        expected = {
                            ...
                            "expected_tools": ["get_payment", "search_policy", "create_refund_request"],
                            "expected_args": [{"tool": "get_payment", "params": {"payment_id": "ORD-20002"}}],
                    ...
                    payload = {
                        ...
                        "messages": [
                            {"role": "customer", "content": msg_body}
                        ]
                    }
